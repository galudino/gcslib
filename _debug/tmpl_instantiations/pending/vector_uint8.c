...
struct typetable ttbl_vector_uint8_t = {
...
struct typetable *_vector_uint8_t_ = &ttbl_vector_uint8_t;
...
struct iterator_table itbl_vector_uint8_t = {
    vibegin_uint8_t,
    viend_uint8_t,
    vinext_uint8_t,
    vinextn_uint8_t,
...
struct iterator_table *_vector_iterator_uint8_t_ = &itbl_vector_uint8_t;
...
vector_uint8_t *vnew_uint8_t(void) {
    vector_uint8_t *v = vallocate_uint8_t();
    vinit_uint8_t(v, 16);
    return v;
}
...
void veraseat_uint8_t(vector_uint8_t *v, size_t index) {
    ...
    curr = v->impl.start + index;
    next = index <= vcapacity_uint8_t(v) ? (curr + 1) : NULL;
    sentinel = v->impl.finish;
...
static iterator vibegin_uint8_t(void *arg) {
    ...
    it.itbl = _vector_iterator_uint8_t_;
    it.container = v;
...
static iterator vinext_uint8_t(iterator it) {
    ...
    iter.itbl = _vector_iterator_uint8_t_;
    iter.container = v;
    iter.curr = it.curr;
